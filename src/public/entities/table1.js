...
async function fetch_and_draw_table(movies, filters){
    ...
    if (filters == null) {
        ...
        const _url = 'http://127.0.0.1:3000/api/findWhere';
...
function draw_table(input) {
    ...
    var table = new google.visualization.Table(document.getElementById('table1-div'));
